	...
	<div id="wrap" class="container">
		...
		<section class="contents">
			...
			<div class="d-flex mt-4 border border-success p-3">
				<!-- 앨범커버 이미지 -->
				<div>
					<img src="https://image.genie.co.kr/Y/IMAGE/IMG_ALBUM/081/111/535/81111535_1539157728291_1_600x600.JPG" alt="앨범 이미지" width="150">
				</div>
				
				<!-- 앨범 정보 -->
				<div class="ml-3">
					<h2>곡 제목</h2>
					<small class="text-success">가수이름</small>
					<table>
						<tr>
							<td>앨범</td>
							<td></td>
